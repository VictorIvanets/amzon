...
function u() {
  const o = document.querySelector(".sliderbox")
  o.innerHTML = ""
  const s = d.map(
    (r) => `
...
document.addEventListener("DOMContentLoaded", () => {
  u()
  const o = document.querySelector(".sliderbox"),
    s = document.querySelector(".arrow__left"),
    r = document.querySelector(".arrow__right"),
    n = document.getElementById("prew"),
    e = document.getElementById("next"),
    t = () => {
      const i = o.querySelector(".sliderbox__item")
      if (!i) return 0
      const a = window.getComputedStyle(i),
        l = i.offsetWidth,
        c = parseFloat(a.marginRight) || 0
      return l + c - 1
    }
  r.addEventListener("click", () => {
    o.scrollBy({ left: t(), behavior: "smooth" })
  }),
    s.addEventListener("click", () => {
      o.scrollBy({ left: -t(), behavior: "smooth" })
    }),
    n.addEventListener("click", () => {
      o.scrollTo({ left: 0, behavior: "smooth" })
    }),
    e.addEventListener("click", () => {
      o.scrollTo({ left: o.scrollWidth, behavior: "smooth" })
    })
})
